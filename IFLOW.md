...
│   └── utils.js          # 通用工具函数
└── data/                 # 数据定义
    ├── personnelData.js  # 人员数据
    └── evaluationCriteria.js  # 评价标准

scripts/                  # 数据库管理脚本
├── setup-database-tables.js    # 数据库表创建
├── upload-personnel-to-db.js   # 人员数据上传
├── create-user-based-tables.sql # 用户评价表创建
├── fix-rls-policies.js         # RLS策略修复
